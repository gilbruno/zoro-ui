...
const useGetMenuItems = () => {
  ...
  return useMemo(() => {
    ...
    menuItems.push(
      ...
      {
        href: routes.polygon.path,
        // Translation key: do not remove this comment
        // t('layout.menuItems.discord')
        i18nKey: 'layout.menuItems.polygon',
        icon: (
          
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/1999/xlink" x="0px" y="0px"
              viewBox="0 0 38.4 33.5" xmlSpace="preserve">
            <g>
